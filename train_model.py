...
class DrugDataset(utils.Dataset):
    ...
    def load_shapes(self, count, img_floder, mask_floder, imglist, dataset_root_path):
        ...
        self.add_class("shapes", 1, "worm") # 黑色素瘤
    ...
    """
        ...
        for i in range(len(labels)):
            if labels[i].find("worm") != -1:
                # print "box"
                labels_form.append("worm")
...
if init_with == "imagenet":
    ...
    model.load_weights('/Users/zhangjun/Desktop/Mask_RCNN-master/logs/mask_rcnn_shapes_0010.h5', by_name=True)
